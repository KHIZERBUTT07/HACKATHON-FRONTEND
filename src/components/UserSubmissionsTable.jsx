      ...
      <table className="w-full">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="p-2 text-left">Token</th> {/* Token column */}
        ...
        <tbody>
          {currentItems.map((submission) => (
            <tr key={submission.id} className="border-t">
              ...
              <td className="p-2 font-bold text-blue-600">{submission.token}</td> {/* Token */}
              <td className="p-2">
                <span
              ...
              <td className="p-2">
                <button
                  ...
                  className="bg-gray-200 text-gray-800 px-2 py-1 rounded mr-2 text-sm hover:bg-gray-300"
                >
                  Details
                </button>
                {submission.status === "Pending" && (
                  <>
                    <span
                      ...
                      className="bg-green-500 text-white px-2 py-1 rounded mr-2 text-sm cursor-pointer hover:bg-green-600"
                    >
                      Accept
                    </span>
                    <span
